...
\footnote{\citetitle{TypabilityTypeCheckingSystemFUndecidable}, \cite{TypabilityTypeCheckingSystemFUndecidable}}.
...
\footnote{\citetitle{HaskellSystemFC}, \cite{HaskellSystemFC}}.
...
\begin{figure}
    ...
    \begin{spacedbnf}
        ...
        | $\tau$ : \small{monotipo}
        | $\forall\ \alpha\ \mathord{.}\ \sigma$ : \small{politipo}
        ;;
        $\tau$ : \small{Tipo} ::=
