...
\footnote{\citetitle{Hindley-1969-SchemeObject}, \cite{Hindley-1969-SchemeObject}
    e \citetitle{Milner-1978-TheoryPolymorphism}, \cite{Milner-1978-TheoryPolymorphism}},
...
\begin{itemize}
    ...
    \item \textbf{variabili libere}: l'insieme delle variabili libere di un tipo è semplicemente il complemento
          delle variabili vincolate, quantificate universalmente in un tipo polimorfo.
\end{itemize}
