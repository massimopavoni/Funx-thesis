...
impure o di effettuare almeno operazioni d'input/output. Inoltre, molti linguaggi prevalentemente
...
per gestire le operazioni d'input/output e altre impurità, mantenendo le funzioni pure.
